...
<body>
    ...
    <section class="flex lg:flex-row flex-col lg:mt-20 mt-3">
        <div class="lg:w-[20%] bg-white shadow-lg flex-col lg:ml-20 mb-5 h-full lg:mx-0 mx-8 mx-4 space-y-3 pb-3">
            ...
            <a href="/order" class="flex font-inter text-[#382B00] text-lg">
            ...
            <a href="/review" class="flex bg-[#F5F5F5]  font-inter text-[#382B00] text-lg">
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="ml-5">
            ...
            <a href="/saved" class="flex font-inter text-[#382B00] text-lg">
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="ml-5">
        ...
        <div class="lg:w-[80%] bg-white shadow-lg flex-col lg:mx-20 lg:px-16 lg:pt-5 lg:pb-8 mb-20 mx-8 px-5 mb-5">
            <p class="font-inter text-[#382B00] text-lg lg:mt-0 mt-5 font-bold">Reviews</p>
            ...
            <div class="flex justify-between mt-8 mb-5">
                <div class="flex md:flex-row flex-col">
                    ...
                    <div class="flex flex-col md:ml-5 lg:text-lg text-base">
                        ...
                        <p class="font-inter text-[#382B00]">Ordered on XX, XXX</p>
                        <p class="font-inter text-[#382B00] mt-12">Delivered on XX, XXX</p>
                    </div>
                </div>

                <a href="#"class="text-[#005E93] items-end ml-5">Review this Product</a>
            </div>
       ...
       <footer class="lg:px-28 p-5 bg-[#FFFBEF] border-t-2 border-amber-800 mt-10">
            ...
            <div class="flex items-center md:mb-0 mb-8">
                <ul class="flex flex-col md:flex-row items-start md:items-center md:gap-0 gap-1 space-x-0 md:space-x-8 lg:space-x-12 md:ml-20 font-medium">
                    ...
                    <li><a href="/products">Whats New</a></li>
                </ul>
            </div>
