...
<body>
    ...
    <nav id="menu" class="flex flex-col pl-10 hidden bg-[#382B00] text-white space-y-2">
        <a href="" class="mt-2">Category</a>
        <a href="">Deals</a>
        <a href="">What's New</a>
        <a href="">Account</a>
        <a href="">Cart</a>
    ...
    <section class="flex lg:flex-row flex-col lg:mt-20 mt-3">
        <div class="lg:w-[20%] bg-white shadow-lg flex-col lg:ml-20 mb-5 h-full lg:mx-0 mx-5 space-y-3 pb-3">
            ...
            <a href="" class="flex bg-[#F5F5F5] flex font-inter text-[#382B00] text-lg">
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="ml-5">
        ...
        <div class="lg:w-[80%] bg-white shadow-lg flex-col lg:mx-20 lg:px-16 lg:pt-5 lg:pb-8 mb-20 mx-5 px-3">
            <p class="font-inter text-[#382B00] text-lg lg:mt-0 mt-5 font-bold">Saved Products (3)</p>
            ...
            <div class="flex justify-between mt-8 mb-5">
                <div class="flex md:flex-row flex-col">
                    ...
                    <div class="flex flex-col md:ml-5 lg:text-lg text-base">
                        <p class="font-inter text-[#382B00]">First Asoebi Product Name</p>
                        <p class="font-inter text-[#382B00]">₦23,300</p>
                        <p class="font-inter text-[#382B00] mt-12">Sizes S - XXXL</p>
                    </div>
                </div>

                <div class="flex-col">
                    <p class="bg-[#D4AF37] rounded-full md:mb-16 py-2 px-2 md:px-5 text-sm md:text-base text-white">Add to Cart</p>

                    <a href="#" class="text-[#D4AF37] flex items-end md:mt-16 mt-32">
                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="mr-3">
                            <rect width="26" height="26" fill="url(#pattern0_418_1451)"/>
                            <defs>
                            <pattern id="pattern0_418_1451" patternContentUnits="objectBoundingBox" width="1" height="1">
                            <use xlink:href="#image0_418_1451" transform="scale(0.015625)"/>
                            </pattern>
                            <image id="image0_418_1451" width="64" height="64" xlink:href="data:image/png;base64,"/>
                            </defs>
                        </svg>
                        Remove
                    </a>
