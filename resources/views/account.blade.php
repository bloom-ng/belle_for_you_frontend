...
<body>
    ...
    <section class="flex lg:flex-row flex-col lg:mt-20 mt-3">
        ...
        <div class="lg:w-[80%] bg-white shadow-lg flex-col lg:mx-20 lg:px-16 lg:mt-0 mt-10 mb-20 mx-5 px-8 py-5 lg:pb-8 pb-5">
            <p class="font-inter text-[#382B00] text-lg">Account Overview</p>
            ...
            <div class="bg-[#F5F5F5] rounded-lg p-5 mt-5 flex-col">
                <p>Account Details</p>
                ...
                <p class="font-inter text-[#382B00] text-lg mt-5">Client Name</p>
                <p class="font-inter text-[#382B00] text-lg mt-3">client@gmail.com</p>
                <p class="font-inter text-[#382B00] text-lg mt-3">0904 888 9999</p>
            </div>

            <div class="bg-[#F5F5F5] rounded-lg p-5 mt-5 flex-col">
                <p class="font-inter text-[#382B00] text-lg">Address(es)</p>
                ...
                <p class="font-inter text-[#382B00] text-lg mt-5">Client Name</p>
                <p class="font-inter text-[#382B00] text-lg mt-3">House number, & Block Maybe House</p>
                <p class="font-inter text-[#382B00] text-lg mt-3">Street Name, Location, & all</p>
                <p class="font-inter text-[#382B00] text-lg mt-3">City, State</p>
                <p class="font-inter text-[#382B00] text-lg mt-3">0904 888 9999</p>
            </div>
        </div>
    </section>
