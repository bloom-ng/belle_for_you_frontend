...
<body>
    ...
    <section class="w-full lg:flex-row flex flex-col p-10">
        <div class="lg:w-1/2 lg:mx-16 lg:mb-10 mb-16 lg:mt-10">
            <img src="/images/aboutimage.jpg" alt="image" class="w-auto h-auto">
        </div>
  
        <div class="lg:w-1/2 lg:mx-16 lg:py-10">
